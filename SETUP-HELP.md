# Cases Simulator - Setup help

Everything you need to get **Cases Simulator** running, step by step. If something goes wrong, check *Troubleshooting* at the end.
...
1. Download **`Cases-Simulator-v1.2.22.mcaddon`** from the [Releases page](../../releases) - or directly from this repository.
...
- Craft a **Case Key** (shapeless: 4 diamonds + 4 iron ingots), or take it from the creative inventory (*Items*).
- Take a Silver, Gold or Diamond **case** from the creative inventory (*Items*), keep a key in your inventory and right-click the case.
- Rarity odds rise with the case tier; a legendary pull is announced to everybody in chat.
